...
func NewRouter(
	...
	api.Get("/profile/link-masters", profileServer.ListProfileLinkMasters)
	api.Post("/profile/link-masters", profileServer.CreateProfileLinkMaster)
	api.Put("/profile/link-masters/{id}", profileServer.UpdateProfileLinkMaster)
